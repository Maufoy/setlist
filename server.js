...
<head>
  ...
  <!-- SEO & Social Sharing -->
  <meta name="description" content="Detalhes da produção: ${item.cliente}">
  <meta property="og:title" content="Set List - ${item.cliente}">
  <meta property="og:description" content="Confira a lista de equipamentos e equipe para esta produção.">
  <meta property="og:image" content="https://setlist.pixelco.com.br/icon.png">
  <meta property="og:type" content="article">
  <meta name="twitter:card" content="summary">
  <meta name="twitter:image" content="https://setlist.pixelco.com.br/icon.png">
